                        ...
                        <div class="products-goods-cart-wrap">
                            <div class="products-goods-cart">
                                <div class="products-goods-cart__img-wrap">
                                    <img class="products-goods-cart__img" src="<?php bloginfo('template_url') ?>/assets/img/fastener_store/GM_07350 копия.JPG" alt="">
                                </div>
                                ...
                                <div class="products-goods-cart__rank">
                                    <div class="products-goods-cart__stars">
                                        <span>
                                            <img src="<?php bloginfo('template_url') ?>/assets/img/star-full.png" alt="">
                                        </span>
                                        <span>
                                            <img src="<?php bloginfo('template_url') ?>/assets/img/star-full.png" alt="">
                                        </span>
                                ...
                                <div class="products-goods-cart__btns">
                                    ...
                                    <span class="products-goods-cart__basket">
                                        <img src="<?php bloginfo('template_url') ?>/assets/img/bag_dark.svg" alt="">
                                    </span>
                                    <span class="products-goods-cart__heart">
                                        <img src="<?php bloginfo('template_url') ?>/assets/img/heart_dark.svg" alt="">
                                    </span>
                                </div>
                            </div>
                            <div class="products-goods-cart">
